...
const DashboardCard: React.FC<DashboardCardProps> = ({
	...
	return (
		<div className="bg-[#050505] rounded-md p-4 text-white w-full flex flex-col justify-between gap-2 min-h-[120px] noise shadow-1 text-left">
			{/* Header: Title + Action */}
			<div className="flex justify-between items-start">
				...
				<button
					...
					className="bg-white text-black px-3 py-1 rounded-md text-sm font-medium flex items-center gap-2 self-center cursor-pointer"
				>
					<img
