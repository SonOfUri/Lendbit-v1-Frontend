...
const LiquidityPoolCard: React.FC<Props> = ({
    ...
    return (
        <div className="bg-[#111] text-white rounded-xl p-4 w-full max-w-sm flex flex-col justify-between shadow-md">
            ...
            <div className="text-sm space-y-2 mb-6">
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex flex-col items-center text-right">
                        <img src={getRiskIcon()} alt={`${riskLevel} risk`} width={40} height={40} />
                        <span className="text-xs text-gray-300 mt-1 uppercase">Low Risk</span>
                    </div>
                </div>
                ...
                <div className="flex gap-4 justify-center">
                    ...
                    <CustomBtn1 label="Borrow" variant="secondary" onClick={onBorrowClick} />
                </div>
        </div>
    );
};
